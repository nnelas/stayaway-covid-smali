...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->val$promise:Lcom/facebook/react/bridge/Promise;
...
.method public onSuccess(Lfct/inesctec/stayaway/tracing/internal/networking/models/AuthenticationCodeResponseModel;)V
    ...
    iget-object v1, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->val$context:Landroid/content/Context;

    invoke-static {v1}, Lfct/inesctec/stayaway/tracing/internal/storage/SecureStorage;->getInstance(Landroid/content/Context;)Lfct/inesctec/stayaway/tracing/internal/storage/SecureStorage;

    move-result-object v1

    iget-object v2, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->val$authCode:Ljava/lang/String;

    invoke-virtual {v1, v2, v0}, Lfct/inesctec/stayaway/tracing/internal/storage/SecureStorage;->saveInformTimeAndCodeAndToken(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->val$promise:Lcom/facebook/react/bridge/Promise;
    ...
    const-string v5, "Invalid auth code response"
    ...
    :cond_0
    iget-object v3, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->this$0:Lfct/inesctec/stayaway/tracing/TracingManagerModule;

    invoke-static {v3, v0}, Lfct/inesctec/stayaway/tracing/TracingManagerModule;->access$100(Lfct/inesctec/stayaway/tracing/TracingManagerModule;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v5, p0, Lfct/inesctec/stayaway/tracing/TracingManagerModule$2;->val$promise:Lcom/facebook/react/bridge/Promise;

    invoke-static {v3, v2, v4, v5}, Lfct/inesctec/stayaway/tracing/TracingManagerModule;->access$200(Lfct/inesctec/stayaway/tracing/TracingManagerModule;Ljava/util/Date;Ljava/lang/String;Lcom/facebook/react/bridge/Promise;)V
